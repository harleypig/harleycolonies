...
Tracked, actionable work lives in
[GitHub issues](https://github.com/harleypig/harleycolonies/issues). This
file holds the idea backlog — things not yet shaped enough to be an issue.
When an item here becomes concrete, file it and remove it from this list.
