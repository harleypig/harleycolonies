...
**Just Enough Archaeology** integrates archaeology information into JEI
(Just Enough Items), allowing players to view which items can be found in
suspicious sand and suspicious gravel blocks. The mod displays archaeology
...
- `atm_compat` (default: `true`)
  - Enable compatibility with ATM (All The Mods). When enabled, the mod
    integrates with ATM modpack's archaeology features.

- `betterarcheology_compat` (default: `true`)
