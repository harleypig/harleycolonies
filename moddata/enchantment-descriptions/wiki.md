...
**Enchantment Descriptions** adds tooltips to enchantment books and
enchanted items, displaying what each enchantment does. The mod provides
...
- **Comprehensive Coverage**: Works with both vanilla and modded
  enchantments.
