...
vanilla limits, allowing players to see much farther into the distance.
This mod is particularly useful for players with powerful hardware who want
to take advantage of increased view distances for better visibility and
...
- `maxRenderDistance` (default: `64`)
  - Maximum allowed render distance in chunks. This sets the upper limit
    for how far players can see, beyond vanilla Minecraft's default
